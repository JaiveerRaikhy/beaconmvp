...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="border-b border-amber-200/30 glass" role="banner">
        <nav className="container mx-auto flex h-14 items-center justify-between px-4" aria-label="Main navigation">
          <Link href="/" aria-label="Beacon home" className="text-2xl font-bold text-[#dd973c]">
            Beacon
          </Link>
      ...
      <main id="main-content" className="flex-1 flex items-center justify-center gradient-primary relative overflow-hidden" role="main">
        ...
        <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#dd973c] rounded-full opacity-5 blur-3xl" />
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#c87b33] rounded-full opacity-5 blur-3xl" />
        </div>
        ...
        <div className="text-center space-y-8 px-4 max-w-2xl relative z-10">
          <h1 className="text-5xl font-bold tracking-tight sm:text-6xl text-foreground" style={{ letterSpacing: '-0.025em' }}>
            Find your
            <span className="block bg-gradient-to-r from-[#dd973c] to-[#c87b33] bg-clip-text text-transparent">career mentor</span>
          </h1>
      ...
      <footer className="border-t border-amber-200/30 bg-background py-6">
